...
label aonl_day4_alt:
    ...
    if aonl_sl_story:
        ...
        "Поднимаю глаза и встречаюсь с ним взглядом, наши губы в паре сантиметрах друг от друга." 
        ...
        window show
        "Но в глубине души..."
        "Я осознаю, что всё было совершенно не так."
        "Реальность довольно жестока со мной."
    ...
    if aonl_un_story:
        ...
        "Он обнимает за талию, моя рука обвивается его шея, ложась на плечо, твердое как камень, плечо настоящего мужчины, МОЕГО МУЖЧИНЫ!"
    ...
    if aonl_sl_story:
        ...
        "Уже поздно что-либо менять. Уверена, тогда я сделаю только хуже.{nw}"  
    ...
    if aonl_un_story:
        ...
        "Мику оставила порошок и убежала по своим делам."
        window hide
        stop sound_loop
        play sound sfx_close_water_sink
        pause 1
    ...
    show aonl_un25 normal future behind prologue_dream with dissolve
    ...
    if aonl_sl_story:
        ...
        show aonl_un25 serious future with dspr
    ...
    th "Я не хочу снова краснеть перед ним, как томат в теплице!" 
    ...
    if aonl_sl_story:
        window show
        "Выйдя наружу, я облегчённо выдохнула."
        th "Какая же я дрянь." 
    ...
    mi"Советский Союз же воевал с Японией, причём дважды, ещё будучи Российской империей! И вряд ли подобные ему были в чести…"
    ...
    mi "Оленька, вы нашли Сашу? Я была на остановке, но его там нет, а ещё Сёма туда ходил. Потом дежурила в музыкальном клубе, надеялась он зайдёт услышав, песню, если будет рядом, но Сашенька так и не пришёл. Я совсем расстроилась, но Лена сказала…"
    show mi sad pioneer with dspr
    mt "Пока не нашли!"
    ...
    mz "Что?!"
    me "Ничего…"
    "Пока они обменивались любезностями, я незаметно оправила юбку."
    ...
    el "Абсолютно!"
    show pi normal aonl_pioneer at fright behind el with dissolve
    ...
    if aonl_un_story:
        ...
        th "Если бы он только позвал… Тогда что?"
        th "Тогда бы пошла не задумываясь, но Сёма кажется не уверен в своих силах." 
    ...
    "Усадив девушку на кровать, я расположилась рядом."
    ...
    "Я обняла её и положила голову девушки мне на плечо, поглаживая волосы, как маленькой."
    ...
    if aonl_sl_story:
        ...
        window show
        "Легла на кровать и попыталась заснуть. Бесполезно."
        "Вышла из домика."
        window hide
        ...
        sl "Извини, что напугала, я не хотела."
    ...
    if aonl_un_story:
        ...
        me "Ну, ему верить…"
        "Он глупо усмехнулся, пытаясь свести всё к шутке, но я продолжала всё так же серьёзно смотреть на него."
        ...
        "В каждом кусте мерещилось чудовище, отовсюду раздавался шелест листвы и скрип веток, но я не показывала страха. Сёма наверняка тоже боится хоть и старается держаться молодом, не стоит его отвлекать своим нытьём, он мужчина пусть ведёт."
        "Мы двигались как рассказал Серёжа, вроде бы в верном направлении, но минут через 10 возникло чувство будто заблудились."
        "Незаметно покосилась на Сёму. Его челюсть плотна сжата, а взгляд сосредоточен."
        ...
        show pi upset aonl_pioneer with dissolve
        "Посмотрев на Сёму поняла, что он сам не в лучшем состоянии."
        un "Боишься?"
        ...
        un "Но зачем?"
        me "Не знаю…"
        "За разговором о детстве мы совершенно не заметили, как подошли ко входу."
        window hide
        stop ambience fadeout 2
        ...
        un "Наверное, ты прав."
        "Я расстроилась, понимая правоту Сёмы, но осталась на месте. Что-то не давало уйти."
        me "Ну правда!"
        ...
        $ persistent.sprite_time = "night"
        window show
        "Внутри обнаружили прибор и две кровати с шкафчиками."
        "Я порылась в одном из них."
        un "Смотри."
        "Я протянула Сёме пистолет."
        show pi surprise aonl_pioneer with dspr
        me "Зачем мне это?"
        ...
        me "Гарантирую!"
        "Хоть и упирался, но всё же засунул пистолет за пояс."
        "Я окинула его взглядом оценивая новый образ."
        ...
        "Изучив помещение, нашли другую металлическую дверь."
        un "Может быть, этим?"
        "Я протянула подала ломик."
...
label aonl_mine_coalface:
    ...
    window show
    "Вскоре показалось помещение с рубленными стенами и высоким потолком."
...
label aonl_mine_exit:
    ...
    me "Эх…"
    "Сёма обессиленно сполз по стене на пол."
    ...
    me "Слава богу…"
    "Осмотревшись из-за решётки Сёма сказал, что мы у памятника Генде."
    ...
    with dissolve
    window show
    "Выбравшись на поверхность, Сёма измотанный упал на траву."
    me "Ужас какой-то…"
    "Дышал он тяжело."
    window hide
    ...
    un "Спокойной ночи."
    show blink
    "Глаза закрылись, и я увидела Сёму, отталкивающего меня от удара Шурика."
